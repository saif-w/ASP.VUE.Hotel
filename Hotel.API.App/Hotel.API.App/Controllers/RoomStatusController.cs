...
namespace Hotel.API.App.Controllers
{
    ...
    {
        private readonly IRoomStatusRepostry _context;
        public RoomStatusController(IRoomStatusRepostry context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] RoomStutas model)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] RoomStutas model)
        {
            try
            {
