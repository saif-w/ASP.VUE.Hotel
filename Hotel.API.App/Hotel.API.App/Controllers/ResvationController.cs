...
namespace Hotel.API.App.Controllers
{
    ...
    [ApiController]
    public class ResvationController : ControllerBase
    {
        private readonly IResvationRepository _context;
        public ResvationController(IResvationRepository context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] Resvation model)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] Resvation model)
        {
            try
            {
