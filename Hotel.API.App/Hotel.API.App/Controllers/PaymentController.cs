...
namespace Hotel.API.App.Controllers
{
    ...
    {
        private readonly PaymentRepostiory _context;
        public PaymentController(PaymentRepostiory context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] Payment model)
        {
            try
            {
